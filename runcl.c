...
static const char help_msg[] =
	...
	"\n"
	"Commands:\n"
	" watchdog add DEVICE [TIMEOUT [PRETIMOUT]]\n"
	...
	" watchdog change DEVICE TIMEOUT [PRETIMOUT]\n"
	...
	" remove [KEY=VALUE ... [KEY2!=VALUE2]] [PROGRAM] [ARGUMENT ...]\n"
	"	Remove a service\n"
	" remove *\n"
	"	Remove all services\n"
	" reload|manual [KEY=VALUE ... [KEY2!=VALUE2]] [PRORAM] [ARGUMENT ...]\n"
	"	Retries a throttled service once\n"
	"	For services with INTERVAL, trigger once out-of-schedule\n"
	" stop|pause|suspend [KEY=VALUE ... [KEY2!=VALUE2]] [PRORAM] [ARGUMENT ...]\n"
	"	Stops a service, but do not forget about it\n"
	" start|resume [KEY=VALUE ... [KEY2!=VALUE2]] [PRORAM] [ARGUMENT ...]\n"
	"	resumes a service\n"
	" restart [KEY=VALUE ... [KEY2!=VALUE2]] [PRORAM] [ARGUMENT ...]\n"
	...
	" status [-wsadxq] [KEY=VALUE] [KEY2!=VALUE2] [PROGRAM] [ARGUMENT ...]\n"
	...
	"	Special matches:\n"
	"	* PID=*		match any non-zero pid\n"
	"	* PID!=VAL	match any non-zero pid\n"
	"	* PAUSED=1|0	match paused|not paused services\n"
	"	* ONESHOT=1|0	match oneshot|repeating services\n"
